...
public class PoseCanvas extends JPanel{
	...
	private String currentSelectedJoint = BodyModelImpl.JOINT_TAG.HEAD.name();
	...
	public void setPose(Posture pose) {
		this.pose = pose;
	}
	...
	public void drawPose(GLAutoDrawable drawable){
		...
		//g.fillRect(head[0]-SQUARE_RADIUS, head[1]-SQUARE_RADIUS,SQUARE_HEIGHT,SQUARE_HEIGHT);
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.HEAD.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.SHOULDER_CENTER.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		/*Drawing line between head and shoulder center */
		//g.drawLine(head[0], head[1],sc[0],sc[1]);
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.SPINE.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		//g.fillRect(s[0]-SQUARE_RADIUS, s[1]-SQUARE_RADIUS,SQUARE_HEIGHT,SQUARE_HEIGHT);
		/*Drawing line between shoulder center and spine */
		//g.drawLine(sc[0], sc[1],s[0],s[1]);
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.HIP_LEFT.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		gl.glColor3f(0,0, 1);
		/*Drawing line between spine and left heap */
		//g.drawLine(s[0], s[1],hl[0],hl[1]);
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.HIP_RIGHT.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		/*Drawing line between spine and right heap */
		//g.drawLine(s[0], s[1],hr[0],hr[1]);
		gl.glBegin(GL2.GL_LINE_STRIP);
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.KNEE_LEFT.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		/* Drawing line from left hip to left knee */
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.KNEE_RIGHT.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		/* Drawing line from right hip to right knee */
		//g.drawLine(hr[0], hr[1],kr[0],kr[1]);
		gl.glBegin(GL2.GL_LINE_STRIP);
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.ANKLE_RIGHT.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		/* Drawing line from right knee to right ankle */
		//g.drawLine(kr[0], kr[1],ar[0],ar[1]);
		gl.glBegin(GL2.GL_LINE_STRIP);
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.ANKLE_LEFT.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		/* Drawing line from right knee to right ankle */
		//g.drawLine(kl[0], kl[1],al[0],al[1]);
		gl.glBegin(GL2.GL_LINE_STRIP);
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.FOOT_RIGHT.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		/* Drawing line from right knee to right ankle */
		//g.drawLine(ar[0], ar[1],fr[0],fr[1]);
		gl.glBegin(GL2.GL_LINE_STRIP);
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.FOOT_LEFT.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		/* Drawing line from right knee to right ankle */
		//g.drawLine(al[0], al[1],fl[0],fl[1]);
		gl.glBegin(GL2.GL_LINE_STRIP);
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.SHOULDER_LEFT.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		/* Drawing line from shoulder center to left shoulder */
		//g.drawLine(sc[0], sc[1],sl[0],sl[1]);
		gl.glBegin(GL2.GL_LINE_STRIP);
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.ELBOW_LEFT.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		/* Drawing line from left shoulder to left elbow */
		//g.drawLine(sl[0], sl[1],el[0],el[1]);
		gl.glBegin(GL2.GL_LINE_STRIP);
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.SHOULDER_RIGHT.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		//g.drawLine(sc[0], sc[1],sr[0],sr[1]);
		gl.glBegin(GL2.GL_LINE_STRIP);
		gl.glVertex3dv(sc, 0);
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.ELBOW_RIGHT.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		/* Drawing line from right shoulder to right elbow */
		//g.drawLine(sr[0], sr[1],er[0],er[1]);
		gl.glBegin(GL2.GL_LINE_STRIP);
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.WRIST_RIGHT.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		/* Drawing line from right elbow to right wrist */
		//g.drawLine(er[0], er[1],wr[0],wr[1]);
		gl.glBegin(GL2.GL_LINE_STRIP);
		...
		if(currentSelectedJoint.equals(BodyModelImpl.JOINT_TAG.WRIST_LEFT.name())&& render){glut.glutSolidCube(SQUARE_HEIGHT);}glut.glutWireCube(SQUARE_HEIGHT);
		gl.glPopMatrix();
		/* Drawing line from right elbow to right wrist */
		//g.drawLine(el[0], el[1],wl[0],wl[1]);
		gl.glBegin(GL2.GL_LINE_STRIP);
