...
public class FeatureVectorModel {
	...
	private float[] innerLimit = new float[]{50,50,50,50,50,50,50,50,50,50,
	...
	/**
	 * Returns array of floats, contains deviation observed - expected = result
	 * @return
	 */
