		...
		for(int layer = 0; layer < layerCount ; layer++){
			...
			if(layer < layerCount-1){
				...
				for(int i = 0; i < layerSize*layerSize; i++){
					...
					System.out.println("Layer: "+(layer+1)+" Norm Weight:"+ann.getNormalizedWeight(layer,i)+
							" Result:"+(ann.getNormalizedWeight(layer,i)== 0 ? 0:(neuronHeight*zoom/2*ann.getNormalizedWeight(layer,i) )));
