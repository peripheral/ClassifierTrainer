...
public class RandomTreesClassifierWrapper implements IClassifierWrapper{
	...
	public static void main(String[] args) {
		...
		rTreesWrap.setTrainingDataInputFile("testDataAngles.dat");
		rTreesWrap.setTrainingDataTargetFile("testDataTarRTrees.dat");
		rTreesWrap.setRTreesOutputFile("RTreesTrainedAngles.ml");
		rTreesWrap.setInputVectorLength(38);
		rTreesWrap.initiate("RTreesTrainedAngles.ml");
	...
	public static String getTargetLabel(int classVal) {
