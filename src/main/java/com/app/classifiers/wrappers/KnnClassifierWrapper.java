...
public class KnnClassifierWrapper implements IClassifierWrapper {
	...
	public static void main(String[] args) {
		...
		knnWrap.setTrainingDataInputFile("testDataAngles.dat");
		knnWrap.setTrainingDataTargetFile("testDataTarKnn.dat");
		knnWrap.setImageOutDest("knnTrainedAngles.ml");
		knnWrap.setInputLength(38);
		knnWrap.initiate();
		knnWrap.train();
	     knnWrap = new KnnClassifierWrapper();
		knnWrap.setTrainingDataInputFile("testDataDevs.dat");
		knnWrap.setTrainingDataTargetFile("testDataTarKnn.dat");
		knnWrap.setImageOutDest("knnTrainedDev.ml");
		knnWrap.setInputLength(19);
		knnWrap.initiate();
		knnWrap.train();
		knnWrap = new KnnClassifierWrapper();
		knnWrap.setTrainingDataInputFile("testData");
		knnWrap.setTrainingDataTargetFile("testDataTarKnn.dat");
		knnWrap.setImageOutDest("knnTrainedPercents.ml");
		knnWrap.setInputLength(19);
		knnWrap.initiate();
		knnWrap.train();
	}
	...
	public void start(int rate,IClassifierCallbacks callbacks) {
		Thread t = new Thread(){
			public void run() {
