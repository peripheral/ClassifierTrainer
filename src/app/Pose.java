...
public class Pose {
	...
	private Map<String,double[]> jointList = new TreeMap<String, double[]>();

	public Map<String, double[]> getJointList() {
		jointList.clear();
		jointList.put(BodyModel.JOINT_TAG.HEAD.name(),head);
		jointList.put(BodyModel.JOINT_TAG.SHOULDER_CENTER.name(),shoulder_center);
		jointList.put(BodyModel.JOINT_TAG.SHOULDER_LEFT.name(),shoulder_left);
		jointList.put(BodyModel.JOINT_TAG.SHOULDER_RIGHT.name(),shoulder_right);
		jointList.put(BodyModel.JOINT_TAG.ELBOW_RIGHT.name(),elbow_right);
		jointList.put(BodyModel.JOINT_TAG.ELBOW_LEFT.name(),elbow_left);
		jointList.put(BodyModel.JOINT_TAG.HIP_LEFT.name(),hip_left);
		
		jointList.put(BodyModel.JOINT_TAG.SPINE.name(),spine);
		jointList.put(BodyModel.JOINT_TAG.HIP_RIGHT.name(),hip_right);
		jointList.put(BodyModel.JOINT_TAG.WRIST_RIGHT.name(),wrist_right);
		jointList.put(BodyModel.JOINT_TAG.WRIST_LEFT.name(),wrist_left);
		jointList.put(BodyModel.JOINT_TAG.KNEE_LEFT.name(),knee_left);
		jointList.put(BodyModel.JOINT_TAG.KNEE_RIGHT.name(),knee_right);
		jointList.put(BodyModel.JOINT_TAG.ANKLE_LEFT.name(),ankle_left);
		jointList.put(BodyModel.JOINT_TAG.ANKLE_RIGHT.name(),ankle_right);
		jointList.put(BodyModel.JOINT_TAG.FOOT_LEFT.name(),foot_left);
		jointList.put(BodyModel.JOINT_TAG.FOOT_RIGHT.name(),foot_right);
		return jointList;
	}
